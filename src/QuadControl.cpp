...
//  cmd.desiredThrustsN[3] = mass * 9.81f / 4.f; // rear right
  ...
  /////////////////////////////// BEGIN SOLUTION //////////////////////////////
  auto l = L/sqrtf(2.f);
  auto txl = momentCmd.x / l;
  auto tyl = momentCmd.y / l;
  auto tzk = momentCmd.z / -kappa;
...
//  thrust = -(desAccel / R(2, 2) * mass);
    ...
    auto z_err_dot = velZCmd - velZ;
    auto b_z = R(2,2);
    integratedAltitudeError += z_err * dt;

    auto u_1_bar =  kpVelZ * z_err_dot + KiPosZ * integratedAltitudeError + accelZCmd;

    auto c = (u_1_bar - CONST_GRAVITY)/b_z;
    thrust = -mass * c;
...
//  }
  ...
  accelCmd =  kpVel * ( velCmd - vel ) + accelCmd;
